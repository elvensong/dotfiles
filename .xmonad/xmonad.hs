...
myFont      = "xft:Fira Code Retina:size=13:antialias=true"
myBigFont   = "xft:Fira Code Bold:size=13:antialias=true"
myWideFont  = "xft:Fira Code Bold:size=13:antialias=true"
...
myKeys conf = let
  ...
  , ("M-F1"                   , addName "Show Keybindings"                $ return ())
    ...
    , ("M1-d"                  , addName "Restore hidden window (FIFO)"    $ popOldestHiddenWindow)
